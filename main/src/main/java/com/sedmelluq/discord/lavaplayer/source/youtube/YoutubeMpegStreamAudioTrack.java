...
public class YoutubeMpegStreamAudioTrack extends MpegAudioTrack {
    ...
    private static final RequestConfig streamingRequestConfig = RequestConfig.custom().setResponseTimeout(org.apache.hc.core5.util.Timeout.ofMilliseconds(3000)).setConnectionRequestTimeout(org.apache.hc.core5.util.Timeout.ofMilliseconds(3000)).setConnectTimeout(org.apache.hc.core5.util.Timeout.ofMilliseconds(3000)).build();
